...
bool g_program1BatchReadyForManipulator = false;
uint16_t g_program1BatchReadySequence = 0;
...
{
    g_program1BatchReadyForManipulator = false;
}

void markProgram1ManipulatorBatchReady()
{
    g_program1BatchReadyForManipulator = true;
    g_program1BatchReadySequence++;
    Serial.print("P1: 6 plates ready for manipulator, seq=");
    Serial.println(g_program1BatchReadySequence);
}
...
{
    return static_cast<uint8_t>(g_program1State);
}

uint8_t program1GetPassIndex()
{
    return g_program1PassIndex;
}

bool program1IsBatchReadyForManipulator()
{
    return g_program1BatchReadyForManipulator;
}

uint16_t program1GetBatchReadySequence()
{
    return g_program1BatchReadySequence;
}
